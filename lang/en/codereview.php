...
$string['approvegrade'] = 'Approve and send to gradebook';
...
$string['cinocidetected'] = 'No automated check was detected on this commit';
$string['cipending'] = 'Waiting for the automated checks...';
...
$string['commitdatedeclared'] = 'Commit date (declared by the author)';
...
$string['errornosubmission'] = 'There is no submission to act on yet.';
...
$string['flagcontentoverlap'] = '{$a->shared} of {$a->total} files are byte-identical to another submission';
...
$string['flagforkofpeer'] = 'This repository is a fork of another student\'s repository';
$string['flagidenticalcommit'] = 'This exact commit was also submitted by another student';
...
$string['integritynoflags'] = 'No authorship alerts were raised. This does not confirm originality.';
$string['integritypanel'] = 'Authorship verification';
$string['islate'] = 'Submitted after the due date';
$string['membersungrouped'] = '{$a} student(s) on this page are not in a group and cannot submit. Put anyone working alone in a group of their own.';
...
$string['multiplegroupswarning'] = 'You belong to more than one of the groups this activity uses, so it is not clear whose work the repository is. Ask your teacher to leave you in only one of them.';
$string['mytoken'] = 'My GitHub token';
$string['nocheckruns'] = 'No automated check has been recorded for this commit.';
$string['nogroupwarning'] = 'You are not in a group, and this activity is submitted by groups. Ask your teacher to add you to one — a student working alone is put in a group of their own.';
...
$string['privacy:metadata:aiprovider'] = 'Filtered source code from the submitted commit is sent to the configured AI provider to generate a grade suggestion.';
$string['privacy:metadata:aiprovider:sourcecode'] = 'The source code being reviewed.';
$string['privacy:metadata:codereview_airesults'] = 'Grade suggestions generated by AI for a submission.';
$string['privacy:metadata:codereview_airesults:feedback'] = 'The feedback text generated for the submission.';
$string['privacy:metadata:codereview_airesults:suggestedgrade'] = 'The grade suggested for the submission.';
$string['privacy:metadata:codereview_blobs'] = 'Content hashes of the files in a submitted commit, used to verify authorship.';
$string['privacy:metadata:codereview_blobs:blobsha'] = 'The content hash of the file.';
$string['privacy:metadata:codereview_blobs:path'] = 'The path of the file within the repository.';
$string['privacy:metadata:codereview_checkruns'] = 'Results of the automated checks recorded for a submitted commit.';
$string['privacy:metadata:codereview_checkruns:checkname'] = 'The name of the automated check.';
$string['privacy:metadata:codereview_checkruns:conclusion'] = 'The result the check reached.';
$string['privacy:metadata:codereview_flags'] = 'Authorship signals raised on a submission.';
$string['privacy:metadata:codereview_flags:flagtype'] = 'Which signal was raised.';
$string['privacy:metadata:codereview_flags:severity'] = 'How strong the signal is.';
$string['privacy:metadata:codereview_grades'] = 'Grades approved by a teacher.';
$string['privacy:metadata:codereview_grades:feedbackcomment'] = 'The comment written for the student.';
$string['privacy:metadata:codereview_grades:finalgrade'] = 'The grade released to the gradebook.';
$string['privacy:metadata:codereview_grades:graderid'] = 'The teacher who approved the grade.';
$string['privacy:metadata:codereview_submissions'] = 'Repository submissions made by the student.';
$string['privacy:metadata:codereview_submissions:authorlogin'] = 'The GitHub account that authored the submitted commit.';
...
$string['recheckci'] = 'Check again now';
$string['reopensubmission'] = 'Reopen for resubmission';
...
$string['rerunaireview'] = 'Run the AI review again';
$string['resetsubmissions'] = 'Delete all submissions, check results, AI suggestions, authorship signals and grades';
$string['resubmissionnotice'] = 'Submitting again replaces your current entry and discards its check results.';
...
$string['studentgradenotice'] = 'Your grade is released once your teacher has reviewed and approved it.';
$string['submissiondetails'] = 'Submission';
$string['submissionreceived'] = 'Your submission was received. The automated checks are being read.';
...
$string['teamheader'] = 'Group submission';
$string['teamsubmission'] = 'Students submit as a group';
$string['teamsubmission_help'] = 'One repository per group: any member submits it and the result counts for every member, who all receive the approved grade. A student who is in no group, or in more than one of the groups being used, cannot submit — put anyone working alone in a group of their own rather than leaving them ungrouped.';
$string['teamsubmissiongroupingid'] = 'Grouping for student groups';
$string['teamsubmissiongroupingid_help'] = 'Only groups in this grouping form teams. Leave it as None to use every group in the course.';
...
$string['truncatedcode'] = 'The code sent for AI review was truncated by the size limit.';
