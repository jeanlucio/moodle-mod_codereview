...
/**
 * Tests for codereview_grade_item_update() in lib.php.
 *
...
/**
 * Tests for codereview_grade_item_update().
 *
 * @covers ::codereview_grade_item_update
 */
final class lib_grade_item_update_test extends \advanced_testcase {
    ...
    public function test_gradepass_is_applied_to_the_grade_item(): void {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('mod_codereview');
        $instance = $generator->create_instance(['course' => $course->id, 'grade' => 100]);
        $instance->gradepass = 60;

        $result = codereview_grade_item_update($instance);
