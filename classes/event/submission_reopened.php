...
/**
 * Triggered when a teacher reopens a submission for a new attempt.
 *
 * @package    mod_codereview
 * @copyright  2026 Jean Lúcio
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class submission_reopened extends base {
    /**
     * Builds the event from the reopened submission.
     *
    ...
    public static function get_name(): string {
        return get_string('eventsubmission_reopened', 'mod_codereview');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' reopened the submission of the user with id " .
